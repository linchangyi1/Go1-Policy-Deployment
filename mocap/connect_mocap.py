...
def test_classes():
    ...
    totals_tmp = data_descriptions.test_all()
    totals=add_lists(totals, totals_tmp)
    print("")
    print("Test MoCap Frame Classes")
    totals_tmp = mocap_data.test_all()
    totals=add_lists(totals, totals_tmp)
    print("")
...
if __name__ == "__main__":
    ...
    optionsDict = {}
    optionsDict["clientAddress"] = "192.168.50.7"
    optionsDict["serverAddress"] = "192.168.50.2"
    ...
    # for i in range(10):
    #     time.sleep(1)
    #     streaming_client.send_request(streaming_client.command_socket, streaming_client.NAT_FRAMEOFDATA, "",  (streaming_client.server_ip_address, streaming_client.command_port) )
