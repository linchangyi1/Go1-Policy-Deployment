...
from config.transport_teacher_cfg import TransportTeacherCfg
from mocap.config import MocapCfg
import rospy
from nav_msgs.msg import Odometry


class TransportTeacher(Locomotion):
    def __init__(self, cfg: TransportTeacherCfg):
        super().__init__(cfg)
        self._cfg = cfg
    ...
    def _update_object_state_callback(self, msg:Odometry):
        ...
        # print("object_position: ", self._object_position)
    ...
    def get_object_state(self):
        ...
        # print("-------------------")
        # print("object_state_scaled:\n", self._object_state_scaled)
...
if __name__ == "__main__":
    transport_teacher = TransportTeacher(TransportTeacherCfg)
    transport_teacher.run()
